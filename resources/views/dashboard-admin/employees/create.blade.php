    ...
    <form class="" action="{{ route('dashboard.admin.employees.store') }}" method="POST"
        ...
        <div class="mt-6 flex flex-col lg:flex-row">
            <div class="flex-grow space-y-6">
                ...
                <div x-data="{ isActive: false }" class="flex items-center justify-between">
            ...
            <div class="mt-6 flex-grow lg:mt-0 lg:ml-6 lg:flex-shrink-0 lg:flex-grow-0">
                <p class="text-sm font-medium text-gray-700 lg:ml-9" aria-hidden="true">Foto Pegawai</p>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 rounded-md shadow-sm">
                            <div
                                ...
                                <input id="photoInput" name="photo_url" type="file"
