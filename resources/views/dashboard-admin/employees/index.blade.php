    ...
    <div class="sm:flex sm:items-center">
        ...
        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
            <a class="inline-flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto"
                href="{{ route('dashboard.admin.employees.create') }}">Add
                user</a>
        </div>
    </div>
                                ...
                                <tr>
                                    <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-6">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="font-medium text-gray-900">{{ $employee->name }}
                                                </div>
                                    ...
                                    <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                        <div class="text-gray-900">{{ $employee->title_name }}</div>
                                    </td>
                                    ...
                                    <td
                                        ...
                                        <div class="flex justify-center items-center gap-x-7">
                                            <form action="{{ route('dashboard.admin.employees.destroy', $employee) }}"
                                                method="POST">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                            ...
                                            <a href="{{ route('dashboard.admin.employees.edit', $employee) }}"
